...
const TestimonialCard = ({ image, name, testimonial }) => {
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:w-[510px] w-auto py-12 px-14 shadow-xl shadow-gray-100 hover:shadow-2xl hover:shadow-gray-200">
