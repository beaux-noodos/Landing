...
const EventCard = ({ image, date, time, location, description, link }) => {
  return (
    <div
      ...
      className="relative w-[555px] h-[400px]"
    >
      <div className='bg-[#002347] bg-opacity-55 px-6 py-8 text-white w-72 ml-auto'>
        ...
        <a href={link} className='mt-4'>
          <button className='bg-primary hover:bg-secondary text-secondary hover:text-primary text-xs font-semibold px-12 py-4 '>
            VIEW DETAILS
          </button>
        </a>
      </div>
